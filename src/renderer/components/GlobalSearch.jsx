      ...
      <div className="relative">
        ...
        {isSearching && (
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
            <svg className="animate-spin h-4 w-4 text-neutral" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      {showResults && (
        <div className="absolute z-40 left-0 right-0 mt-2 w-full bg-base-100 shadow-lg rounded-lg border border-base-300 overflow-hidden">
          <div className="max-h-96 overflow-y-auto">
            ...
            {(searchResults.patients.length > 0 || searchResults.journals.length > 0) && (
              <button
