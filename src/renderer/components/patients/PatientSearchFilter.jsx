      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="w-full md:w-auto">
            ...
            >
              <option value="all">{t('patients.filters.statusOptions.all')}</option>
              <option value="active">{t('patients.filters.statusOptions.active')}</option>
              <option value="inactive">{t('patients.filters.statusOptions.inactive')}</option>
            </select>
          </div>
          ...
          <div className="w-full md:w-auto">
            ...
            >
              <option value="lastName">{t('patients.filters.sortOptions.lastName')}</option>
              <option value="firstName">{t('patients.filters.sortOptions.firstName')}</option>
              <option value="personalNumber">{t('patients.filters.sortOptions.personalNumber')}</option>
              <option value="createdAt">{t('patients.filters.sortOptions.createdAt')}</option>
            </select>
          </div>
