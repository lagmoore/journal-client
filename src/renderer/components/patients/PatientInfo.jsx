...
const PatientInfo = ({ patient, onSave, isNew }) => {
  ...
  const renderImportantNoteAlert = () => {
    ...
    const style = alertStyles[patient.importantNoteType] || alertStyles.information;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormInput
              type="date"
              name="admissionDate"
              value={formData.admissionDate ? formData.admissionDate.substr(0, 10) : ''}
              onChange={handleChange}
            ...
            <FormInput
              ...
              value={formData.expectedDischargeDate ? formData.expectedDischargeDate.substr(0, 10) : ''}
              onChange={handleChange}
            ...
            <FormInput
              ...
              value={formData.actualDischargeDate ? formData.actualDischargeDate.substr(0, 10) : ''}
              onChange={handleChange}
      ...
      <div className="bg-base-100 rounded-lg shadow-card border border-base-300 overflow-hidden">
        <div className="bg-base-200 px-4 py-3 border-b border-base-300">
          <h3 className="text-lg font-medium">{t('patients.sections.importantNote')}</h3>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="information">{t('patients.importantNote.information')}</option>
              <option value="moderate">{t('patients.importantNote.moderate')}</option>
              <option value="severe">{t('patients.importantNote.severe')}</option>
            </select>
          </div>
        </div>
      </div>
      ...
      <div className="bg-base-100 rounded-lg shadow-card border border-base-300 overflow-hidden">
        <div className="bg-base-200 px-4 py-3 border-b border-base-300">
          <h3 className="text-lg font-medium">{t('patients.sections.caseworker')}</h3>
        </div>
