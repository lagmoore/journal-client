  ...
  const performSearch = async (term) => {
    ...
    try {
      ...
      if (patientsResponse.data.success && journalsResponse.data.success) {
        // Filter results
        const patients = patientsResponse.data.patients.filter(patient => 
        ...
        const journals = journalsResponse.data.journals.filter(journal => 
    ...
    <div className="p-6">
      ...
      {isLoading ? (
        ...
        <div>
          ...
          {!searchTerm && (
            <div className="text-center py-8">
              <p className="text-neutral text-lg">{t('search.searchForSomething')}</p>
            </div>
          )}
          ...
          {searchResults.patients.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xl font-medium mb-4">{t('search.patients')}</h2>
          ...
          {searchResults.journals.length > 0 && (
            <div>
              <h2 className="text-xl font-medium mb-4">{t('search.journals')}</h2>
