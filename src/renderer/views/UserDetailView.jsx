    ...
    try {
      ...
      if (response.data.success) {
        toast.success(isNewUser 
          ? t('users.success.created') 
          : t('users.success.updated')
        );
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary ${
                      formErrors.passwordConfirmation ? 'border-error' : 'border-base-300'
                    }`}
                    placeholder={t('users.placeholders.passwordConfirmation')}
                  />
                  {formErrors.passwordConfirmation && (
                    <p className="text-error text-sm mt-1">{formErrors.passwordConfirmation}</p>
                  )}
                </div>
              </div>
            ...
            <div className="flex justify-end">
              ...
              >
                {isSaving ? (
                  ...
                  isNewUser ? t('common.create') : t('common.save')
                )}
              </button>
            </div>
          </form>
