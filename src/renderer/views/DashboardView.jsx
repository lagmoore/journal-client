        ...
        <nav className="mt-5 px-2">
          <div className="space-y-1">
            ...
            >
              <svg
                className={`mr-3 h-6 w-6 ${
                  activeSection === "dashboard" ? "text-white" : "text-primary"
                }`}
            ...
            >
              <svg
                className={`mr-3 h-6 w-6 ${
                  activeSection === "patients" ? "text-white" : "text-primary"
                }`}
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            >
              <svg
                className={`mr-3 h-6 w-6 ${
                  activeSection === "journals" ? "text-white" : "text-primary"
                }`}
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            {(currentUser?.role === "admin" ||
              ...
              >
                <svg
                  className={`mr-3 h-6 w-6 ${
                    activeSection === "economy" ? "text-white" : "text-primary"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            {currentUser?.role === "admin" && (
              ...
              >
                <svg
                  className={`mr-3 h-6 w-6 ${
                    activeSection === "users" ? "text-white" : "text-primary"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                ...
                <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-base-100 ring-1 ring-black ring-opacity-5 py-1 z-40">
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414l-5-5H3zm6.293 11.293a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3z"
                        clipRule="evenodd"
                      />
                    </svg>
                    {t("common.logout")}
